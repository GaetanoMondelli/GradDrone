package com.example.gaeta.laurea.drone;
...
public class BebopDrone {
    ...
    public void setMaxAltitude(float current){
        mDeviceController.getFeatureARDrone3().sendPilotingSettingsMaxAltitude((float)current);
    }

    public void takeOff() {
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
            mDeviceController.getFeatureARDrone3().sendSpeedSettingsHullProtection((byte)1);
            mDeviceController.getFeatureARDrone3().sendPilotingTakeOff();
            mDeviceController.getFeatureARDrone3().sendCameraOrientationV2((float)-83,0);
        }
    }

    public void changeOrientation(byte tilt){
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
        mDeviceController.getFeatureARDrone3().sendCameraOrientation(tilt,(byte)0);
        }
    }
